...
<div style="display: grid; gap: 1rem; margin-top: 1rem; width: 100%;">
  ...
  <a href="https://github.com/GeodynamicWorldBuilder/WorldBuilder" target="_blank" rel="noopener noreferrer" style="display: block; width: 80%;">
    <img src="{{ '/images/world_builder_logo.webp' | relative_url }}" alt="Geodynamic World Builder logo" style="display: block; width: 80%; height: auto;" />
  </a>
</div>
